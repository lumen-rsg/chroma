/* VENDORED — unmodified copy. Required alongside the generated protocol
   header (wlr-output-power-management-unstable-v1-protocol.h) which
   system wlroots may not install. No C++ patches needed. */
