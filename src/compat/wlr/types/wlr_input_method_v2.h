 ...
 *
 * VENDORED — patched for C++ compatibility:
 *   1. `delete` member of wlr_input_method_v2_state renamed to
 *      `surrounding_delete` (C++ reserved word, hard compilation error).
 *      See PATCHED markers below.
 */
...
struct wlr_input_method_v2_state {
	...
	char *commit_text;
	// PATCHED: renamed from 'delete' — C++ reserved word, hard compilation error
	struct wlr_input_method_v2_delete_surrounding_text surrounding_delete;
};
